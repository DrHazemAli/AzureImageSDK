...
/// <summary>
/// Configuration options for StableImageCore model
/// </summary>
public class StableImageCoreOptions
{
    /// <summary>
    /// Gets or sets the endpoint URL for the StableImageCore deployment
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Gets or sets the API version for StableImageCore
    /// </summary>
    ...
    /// </summary>
    public string ModelName { get; set; } = "Stable-Image-Core";
